...
export const LineChart1 = ({ graphDataProp }) => {
  ...
  return (
    <div>
      <div className="select-box">
        <h3>
          <span>
            <img src="./1_top.svg" alt="pic" />
          </span>
          Average Engine Capacity in <sapn>{graphDataProp.value_unit}</sapn>
          <span className="i-button">
            <MyTooltip
              placement="bottom"
              title={
                <span>
                  10-year average of annual average engine capacity. Click on
                  the legend will lead to disappearance of the line from the
                  chart.
                </span>
              }
            >

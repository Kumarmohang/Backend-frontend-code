...
export const LineChart4 = ({ graphDataProp }) => {
  ...
  return (
    <div>
      <div className="select-box">
        <h3>
          <span>
            <img src="./3_top.svg" alt="pic" />
          </span>
          Average Weight in <sapn>{graphDataProp.value_unit}</sapn>
          <span className="i-button">
            <MyTooltip
              placement="bottom"
              title={
                <span>
                  10-year average of annual average weight Click on the legend

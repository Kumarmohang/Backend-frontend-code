...
export const LineChart6 = ({ graphDataProp }) => {
  let componentGraphData = graphDataProp.data;
  console.log(componentGraphData[1].data, "Racing car data from sith graph");
  console.log("data from graph component", componentGraphData);
  ...
  const [carType, setCarType] = useState("Racing Cars");
  ...
  const [graphData, setGraphData] = useState(componentGraphData[1].data);
        ...
        <h3>
          ...
          <span className="i-button">
            <MyTooltip
              ...
              title={
                <span>
                  10-year average of car type proportion Click on the legend

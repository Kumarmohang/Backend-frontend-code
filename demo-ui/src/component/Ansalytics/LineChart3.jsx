...
export const LineChart3 = ({ graphDataProp }) => {
  ...
  return (
    <div>
      <div className="select-box">
        <h3 className="select-box-heading3">
          <span>
            <img src="./Maximum_power.svg" alt="pic" />
          </span>
          Average Of Maximum Power in <sapn>{graphDataProp.value_unit}</sapn>
          <span className="i-button">
            <MyTooltip
              placement="bottom"
              title={
                <span>
                  10-year average of annual average maximum power. Click on the
